...
public class PingfenxinxiEntity<T> implements Serializable {
	 ...
	 * 设置：评分要求
	 */
	public void setPingfenyaoqiu(String pingfenyaoqiu) {
		this.pingfenyaoqiu = pingfenyaoqiu;
	}
	/**
	 * 获取：评分要求
	 */
	public String getPingfenyaoqiu() {
		return pingfenyaoqiu;
	}
	/**
	 * 设置：发布时间
	 */
